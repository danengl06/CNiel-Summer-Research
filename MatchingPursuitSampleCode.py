...
# Noisy version of dictionary to be recreated
data = (D * 1.2)
...
def matching_pursuit(data, D, num_atoms):
    ...
    for i in range(num_signals):
        ...
        for j in range(num_atoms): #Greedy aproximation loop
...
coefficients, reconstruction = matching_pursuit(data, D, num_atoms=9)
